...
# Refatorada e totalmente em PT-PT. Inclui mapeamentos ordinais.
    ...
    *   **Técnicas de Interpretabilidade Mais Avançadas:** Explorar métodos como SHAP (SHapley Additive exPlanations) ou LIME (Local Interpretable Model-agnostic Explanations) para fornecer insights mais profundos sobre as previsões, tanto a nível global (para o modelo) como individual (para uma previsão 
